...
import com.k.xdiary.views.MySwipeRefreshLayout.RecyclerViewDivider;
...
public class WeightActivity extends RecyclerBaseActivity implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void initView(View view) {
        ...
        //设置分隔线
        recyclerView.addItemDecoration(new RecyclerViewDivider(LinearLayoutCompat.VERTICAL, 0, ContextCompat.getColor(mContext, R.color.dividerColor), 1));
        //设置增加或删除条目的动画
