package com.k.xdiary.views.MySwipeRefreshLayout;
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDivider(@LinearLayoutCompat.OrientationMode int orientation, int decoration, @ColorInt int color, int lineSize) {
